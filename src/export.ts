...
<rect width="1080" height="780" fill="#182c25"/><rect x="50" y="50" width="980" height="680" rx="0" fill="#f4f0e5"/>
<g font-family="PingFang SC,Microsoft YaHei,sans-serif" fill="#a44132"><text x="90" y="122" font-size="32">天机簿 · TIANJI BU</text>
<text x="90" y="164" font-size="18" fill="#697268">传统符号的可解释演算 / An explainable symbolic chart</text>
...
<path d="M90 565H990" stroke="#a4413250"/><text x="90" y="610" font-size="18">${chart.input.mode === 'solar' ? `UTC+08:00 · ${chart.input.sect === 2 ? '00:00 换日 / midnight boundary' : '23:00 换日 / late Zi boundary'}` : '手动四柱 / Manual symbolic input'}</text>
<text x="90" y="648" font-size="17">五行计数不代表力量；规则计算不预测人生。Symbolic rules, not life predictions.</text>
<text x="90" y="683" font-size="15" fill="#697268">${escapeHtml(chart.engine)} · Tianji Bu v0.3.0 · 原始生日已省略，四柱仍可能涉及隐私</text></g></svg>`;
}
